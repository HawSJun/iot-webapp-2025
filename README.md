...
- HTML5 + CSS3 + JS + BootStrap 응용예제
    ...
    https://github.com/user-attachments/assets/82477749-bd8c-4266-ad26-bc5ec464c853
...
10. 전체화면
    ...
    https://github.com/user-attachments/assets/6d4f9180-7f57-43ba-a477-cd319c2a5dfb
...
2. 회원가입 정보 확장
    ...
    - Program.cs 에서 IdentityUser -> CustomUser 로 변경
    - AccountController 에서 IdentityUser -> CustomUser 로 변경
    - _Layout.cshtml, News.Index.cshtml, News.Detail.cshtml 에 IdentityUser -> CustomUser 로 변경
    - ApplicationDbContext.cs 에서 IdentityUser -> CustomUser 로 변경
    - NuGet 패키지 관리자 콘솔에서
...
3. 게시판 준비
    ...
    - BackupModels에서 필요한 모델 클래스를 Models 이전, 수정
    - ApplicationDbContext `DbSet<Board>` 추가
...
- 게시판 목록
    ...
    <img src="./image/portfolio1.png" width="600">

- 게시판 검색

    <img src="./image/portfolio2.png" width="600">

- 게시글 작성

    <img src="./image/portfolio3.png" width="600">

- 게시글 수정

    <img src="./image/portfolio4.png" width="600">    

- 게시글 상세

    <img src="./image/portfolio5.png" width="600">

- 게시글 삭제

    <img src="./image/portfolio6.png" width="600">